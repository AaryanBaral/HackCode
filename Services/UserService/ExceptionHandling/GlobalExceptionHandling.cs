...
public class GlobalException : IExceptionHandler
{
    ...
    private static (int statusCode, string title) HandleSqlException(SqlException sqlEx)
    {
        ...
        return sqlEx.Number switch
        {
            ...
            8115 => ((int)HttpStatusCode.BadRequest, "Arithmetic overflow error."), // Arithmetic error
            ...
            53 => ((int)HttpStatusCode.InternalServerError, "Cannot connect to the server."), // Server not reachable
            ...
            515 => ((int)HttpStatusCode.BadRequest, "Cannot insert NULL value."), // NULL value violation
            9002 => ((int)HttpStatusCode.InternalServerError, "Transaction log is full."), // Log issue
            _ => ((int)HttpStatusCode.InternalServerError, "Sql Error: " + sqlEx.Message), // Default error
        };
    }
}